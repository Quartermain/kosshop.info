			...
			<div class="wrap">
				...
				<div class="tabGroup">
				    ...
				    <div class="tab6" style="padding-left:20px;">
						...
						<!-- item sample -->
						<div class="wpfc-exclude-item" prefix="" content="" style="display:none;">
		    				<div class="app" style="float:left;">
		    					<div style="color: #555;font-size:14px;"><b style="color: black;">IF</b> REQUEST_URI <b style="color: black;" class="wpfc-exclude-item-prefix"></b> <label style="color: #555;font-size:14px;" class="wpfc-exclude-item-content"></label></div>
		    				</div>
		    				<div class="meta" style="float:right;height:19px;">

		    				</div>
		    			</div>
		    			<!-- samples end -->

				    	<div style="width: 100%;float:left;text-align: center;margin-bottom: 11px;">
